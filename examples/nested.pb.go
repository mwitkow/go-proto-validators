...
func (*InnerMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_nested_4d70284b6e9982ca, []int{0}
}
...
func (*OuterMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_nested_4d70284b6e9982ca, []int{1}
}
...
func init() { proto.RegisterFile("examples/nested.proto", fileDescriptor_nested_4d70284b6e9982ca) }

var fileDescriptor_nested_4d70284b6e9982ca = []byte{
